...
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        this.http = http;
        this.apiUrl = "http://192.168.178.35:8080/api";
    }
    ApiService.prototype.callOpenCurtain = function () {
        console.log(this.apiUrl + "/open");
        return this.http.get(this.apiUrl + "/open");
    };
    ApiService.prototype.closeOpenCurtain = function () {
        console.log(this.apiUrl + "/close");
        return this.http.get(this.apiUrl + "/close");
    };
    ApiService.prototype.stopOpenCurtain = function () {
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnRyb2wvY29udHJvbC5jb21wb25lbnQuc2NzcyJ9 */"
...
var ControlComponent = /** @class */ (function () {
    function ControlComponent(apiService) {
        this.apiService = apiService;
    }
    ControlComponent.prototype.ngOnInit = function () {
    };
    ControlComponent.prototype.openCurtain = function () {
        console.log("OpenCurtainCall");
        this.apiService.callOpenCurtain().subscribe();
    };
    ControlComponent.prototype.closeCurtain = function () {
        console.log("closeCurtainCall");
        this.apiService.closeOpenCurtain().subscribe();
    };
    ControlComponent.prototype.stopCurtain = function () {
...
module.exports = __webpack_require__(/*! C:\Users\Mauri\Desktop\WebApp\WebApp\src\main.ts */"./src/main.ts");
